...
public class Endereco {
    ...
    @ManyToOne
    @JoinColumn(name = "fk_user", referencedColumnName = "cpfUser", nullable = true)
    private Usuario usuario;

    @ManyToOne
    @JoinColumn(name = "fk_profissional", referencedColumnName = "registroProfissional", nullable = true)
